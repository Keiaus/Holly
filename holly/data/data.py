...
corpus = os.path.join(p.dataToCorpusPath, corpus_name)
...
printLines(os.path.join(corpus, p.corpusToUtterPath))
...
lines, conversations = load_lines_and_conversations(os.path.join(corpus, p.corpusToUtterPath))
